  ...
  return (
    <div className="w-full h-[100%] overflow-auto scrollbar-hide bg-[#1B1107]">
      <div className="py-[32px] px-[24px] bg-[url('/src/assets/page-images/hero-section.png')]  bg-cover opacity-90">
        <h3 className="text-white text-center text-[18px] md:text-[24px] lg:text-[32px] xl:text-[40px] font-jua">
          Hungry?
        </h3>
        <h3 className="text-white text-center text-[18px] md:text-[24px] lg:text-[32px] xl:text-[40px] mb-[10px] font-jua">
          You are at the right place!
        </h3>
        <p className="text-white text-center text-[12px] lg:text-[16px] xl:text-[20px] mb-[20px]">
