...
function LandingPage() {
  ...
  return (
    <div className=" landing-page w-full h-[100%] overflow-auto scrollbar-hide">
      <div className="hero-div py-[32px] px-[24px] bg-[url('/src/assets/page-images/hero-section.png')]  bg-cover opacity-90">
        <h3 className=" text-center text-[24px] lg:text-[32px] xl:text-[48px]">
          Hungry?
        </h3>
        <h3 className=" text-center text-[24px] lg:text-[32px] xl:text-[48px] mb-[10px]">
          You are at the right place!
        </h3>
        <p className=" text-center text-[14px] lg:text-[16px] xl:text-[20px] mb-[20px]">
