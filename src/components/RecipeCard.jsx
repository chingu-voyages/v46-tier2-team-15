  ...
  return (
    <div className="recipe-card flex flex-col items-center w-[14rem] text-center min-h-[21rem] my-8 mx-6 p-1">
      <div className="img-bg w-full h-24 flex items-start justify-center mb-20 ">
        <img
          className="recipe-image w-40 h-[10rem] m-4  border-4 border-solid"
          src={image}
          alt="recipe image"
        />
      </div>
      ...
      <button
        className="card-button w-[12.5rem] my-1 py-2 flex items-center justify-around border-2 border-solid border-black text-base bg-transparent cursor-pointer"
        onClick={() => {
          getRecipe(recipe);
        }}
      >
